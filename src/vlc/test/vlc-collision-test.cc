...
NS_LOG_COMPONENT_DEFINE ("vlc-collision-test");

/**
 * \ingroup vlc-test
 * \ingroup tests
 *
 * \brief Vlc Collision Test
 */
class VlcCollisionTestCase : public TestCase
{
public:
  VlcCollisionTestCase ();
  virtual ~VlcCollisionTestCase ();
...
VlcCollisionTestCase::VlcCollisionTestCase ()
  : TestCase ("Test the 802.15.7 collision handling")
{
  m_rxPackets = 0;
}
...
void VlcCollisionTestCase::DataIndication (McpsDataIndicationParams params, Ptr<Packet> p)
{
  m_rxPackets++;
}
...
void
VlcCollisionTestCase::DoRun (void)
{
  ...
  dev0->GetMac ()->SetMcpsDataIndicationCallback (MakeCallback (&VlcCollisionTestCase::DataIndication, this));
 ...
 * \ingroup tests
 *
 * \brief Vlc Collision TestSuite
 */
class VlcCollisionTestSuite : public TestSuite
{
public:
  VlcCollisionTestSuite ();
};

VlcCollisionTestSuite::VlcCollisionTestSuite ()
  : TestSuite ("vlc-collision", UNIT)
{
  AddTestCase (new VlcCollisionTestCase, TestCase::QUICK);
}

static VlcCollisionTestSuite g_vlcCollisionTestSuite; //!< Static variable for test initialization
