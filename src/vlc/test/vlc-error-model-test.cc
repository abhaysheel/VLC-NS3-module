...
NS_LOG_COMPONENT_DEFINE ("vlc-error-model-test");

/**
 * \ingroup vlc-test
 * \ingroup tests
 *
 * \brief Vlc Error Vs Distance Test
 */
class VlcErrorTestCase : public TestCase
{
public:
  VlcErrorTestCase ();
  virtual ~VlcErrorTestCase ();
 ...
 * \ingroup tests
 *
 * \brief Vlc Error model Test
 */
class VlcErrorModelTestCase : public TestCase
{
public:
  VlcErrorModelTestCase ();
  virtual ~VlcErrorModelTestCase ();

private:
  virtual void DoRun (void);
};

VlcErrorTestCase::VlcErrorTestCase ()
  : TestCase ("Test the 802.15.7 error model"),
    m_received (0)
{
}
...
void
VlcErrorTestCase::Callback (McpsDataIndicationParams params, Ptr<Packet> p)
{
  m_received++;
}

void
VlcErrorTestCase::DoRun (void)
{
  ...
  cb0 = MakeCallback (&VlcErrorTestCase::Callback, this);
...
// ==============================================================================
VlcErrorModelTestCase::VlcErrorModelTestCase ()
  : TestCase ("Test the 802.15.7 error model")
{
}
...
void
VlcErrorModelTestCase::DoRun (void)
{
 ...
 * \ingroup tests
 *
 * \brief Vlc Error model TestSuite
 */
class VlcErrorModelTestSuite : public TestSuite
{
public:
  VlcErrorModelTestSuite ();
};

VlcErrorModelTestSuite::VlcErrorModelTestSuite ()
  : TestSuite ("vlc-error-model", UNIT)
{
  AddTestCase (new VlcErrorModelTestCase, TestCase::QUICK);
  AddTestCase (new VlcErrorTestCase, TestCase::QUICK);
}

static VlcErrorModelTestSuite g_vlcErrorModelTestSuite; //!< Static variable for test initialization
