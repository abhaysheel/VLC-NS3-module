 ...
 */
#ifndef VLC_SPECTRUM_VALUE_HELPER_H
#define VLC_SPECTRUM_VALUE_HELPER_H
...
class VlcSpectrumValueHelper
{
public:
  VlcSpectrumValueHelper (void);
  virtual ~VlcSpectrumValueHelper (void);
...
#endif /*  VLC_SPECTRUM_VALUE_HELPER_H */
