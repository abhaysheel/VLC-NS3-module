 ...
 */
#ifndef VLC_INTERFERENCE_HELPER_H
#define VLC_INTERFERENCE_HELPER_H
...
class VlcInterferenceHelper : public SimpleRefCount<VlcInterferenceHelper>
{
public:
  /**
   ...
   */
  VlcInterferenceHelper (Ptr<const SpectrumModel> spectrumModel);

  ~VlcInterferenceHelper (void);
...
private:
   ...
   */
  VlcInterferenceHelper (VlcInterferenceHelper const &);
  /**
   * \brief Copy constructor - defined and not implemented.
   * \returns
   */
  VlcInterferenceHelper& operator= (VlcInterferenceHelper const &);
  /**
...
#endif /* VLC_INTERFERENCE_HELPER_H */
