 ...
 */
#ifndef VLC_NET_DEVICE_H
#define VLC_NET_DEVICE_H
 ...
 * accessing the VlcMac pointer to make 802.15.7-specific API calls.
 * As such, this is really just an encapsulating class.
 */
class VlcNetDevice : public NetDevice
{
public:
   ...
   */
  Ptr<VlcCsmaCa> GetCsmaCa (void) const;
  ...
  /**
   * This method indirects to VlcMac::SetShortAddress ()
