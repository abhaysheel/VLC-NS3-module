...
NS_LOG_COMPONENT_DEFINE ("VlcInterferenceHelper");

VlcInterferenceHelper::VlcInterferenceHelper (Ptr<const SpectrumModel> spectrumModel)
...
VlcInterferenceHelper::~VlcInterferenceHelper (void)
{
  m_spectrumModel = 0;
  m_signal = 0;
  m_signals.clear ();
...
bool
VlcInterferenceHelper::AddSignal (Ptr<const SpectrumValue> signal)
{
...
bool
VlcInterferenceHelper::RemoveSignal (Ptr<const SpectrumValue> signal)
{
  NS_LOG_FUNCTION (this << signal);
...
void
VlcInterferenceHelper::ClearSignals (void)
{
...
Ptr<SpectrumValue>
VlcInterferenceHelper::GetSignalPsd (void) const
{
  NS_LOG_FUNCTION (this);
